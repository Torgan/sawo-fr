...
- _Diminution de Trait_ : Combat d8, portée T, 3.

### Actions
- Masse enchantée : Combat d8, 2d6+1, inflige _Diminution de Trait (Force)_ sur une Relance, enutilisant le jet de Combat comme jet d'arcanes
...
### Équipement
Chemise de mailles (+2), masse enchantée (For+d8+1, Combat+1, Diminution de Trait(Force) sur une Relance), arbalète légère.
